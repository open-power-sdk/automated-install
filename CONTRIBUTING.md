...
To work on something, whether a new feature or a bugfix:
  ...
  2. Clone it locally
  ```
  git clone https://github.com/open-power-sdk/sdk-easy-install.git
  ```
  3. Add the upstream repository as a remote
  ```
  git remote add upstream https://github.com/open-power-sdk/sdk-easy-install.git
  ```
  4. Create a branch
